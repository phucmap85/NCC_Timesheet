import { Controller, Get, Put, Post, Query, Body, Delete, HttpCode } from '@nestjs/common';
...
export class RoleController {
  ...
  @Get("GetRoleForEdit")
  async getRoleForEdit(@Query('Id') id: number): Promise<object | null> {
  ...
  async changeRolePermission(@Body() editPermissionsAndId: object): Promise<object | null> {
    return this.roleService.changeRolePermission(editPermissionsAndId);
  }
  ...
  @Delete("Delete")
  async deleteRole(@Query('Id') id: number): Promise<object | null> {
